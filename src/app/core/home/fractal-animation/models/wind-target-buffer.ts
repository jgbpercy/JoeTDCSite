...
export class WindTargetBuffer {
    ...
    constructor() {
        ...
        while (currentTime <= this.bufferDuration) {
            ...
            const newSpike = {
                time: currentTime + this.spikeGapAverage + lodash.random(-this.spikeGapVariance, this.spikeGapVariance, true),
                length: this.spikeLengthAverage + lodash.random(-this.spikeLengthVariance, this.spikeLengthVariance, true),
                strength: this.spikeStrengthAverage + lodash.random(-this.spikeStrengthVariance, this.spikeStrengthVariance, true),
            };
    ...
    public getCurrentWindTargetAtPosition(xPosition : number) : number {
